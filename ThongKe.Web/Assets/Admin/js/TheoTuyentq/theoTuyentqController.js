...
var theoTuyentqController = {
    ...
    registerEvent: function () {
        ...
        $('#btnReset').off('click').on('click', function () {
            theoTuyentqController.resetForm();
        });

        $('#btnSearch').off('click').on('click', function () {
            if ($('#frmSearch').valid()) {
                theoTuyentqController.LoadData();
            }
        });
    ...
    loadDdlTuyentq: function (khoi) {
        ...
        $.ajax({
            url: '/account/GetAllTuyentqByKhoi',
            type: 'GET',
            data: {
                khoi: khoi
            },
    ...
    LoadData: function (changePageSize) {
        ...
        $.ajax({
            url: '/BaoCao/LoadDataSaleTheoTuyentq',
            type: 'GET',
            data: {
                tungay: tungay,
                denngay: denngay,
            ...
            success: function (response) {
                ...
                if (response.status) {
                    ...
                    $('#tblData').html(html);
                    theoTuyentqController.paging(response.total, function () {
                        theoTuyentqController.LoadData();
                    }, changePageSize);
                    theoTuyentqController.loadExportDetail();
                }
            }
        });
    },
