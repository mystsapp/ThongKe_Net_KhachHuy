...
var kinhDoanhOnlineNgaydiController = {
    ...
    registerEvent: function () {
        ...
        $('#btnReset').off('click').on('click', function () {
            kinhDoanhOnlineNgaydiController.resetForm();
        });

        $('#btnSearch').off('click').on('click', function () {
            if ($('#frmSearch').valid()) {
                kinhDoanhOnlineNgaydiController.LoadData();
            }
        });
    ...
    LoadData: function (changePageSize) {
        ...
        $.ajax({
            url: '/BaoCao/LoadDataKinhDoanhOnline_ngaydi',
            type: 'GET',
            data: {
                tungay: tungay,
                denngay: denngay,
            ...
            success: function (response) {
                ...
                if (response.status) {
                    ...
                    $('#tblData').html(html);
                    kinhDoanhOnlineNgaydiController.paging(response.total, function () {
                        kinhDoanhOnlineNgaydiController.LoadData();
                    }, changePageSize);
                    kinhDoanhOnlineNgaydiController.registerEvent();
                }
