...
var tuyentqTheoQuyController = {
    init: function () {
        // tuyentqTheoQuyController.LoadData();
        tuyentqTheoQuyController.loadDdlChiNhanh();
        tuyentqTheoQuyController.registerEvent();
    },
    ...
    registerEvent: function () {
        ...
        $('#btnReset').off('click').on('click', function () {
            tuyentqTheoQuyController.resetForm();
        });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status) {
                    ...
                    $('#tblData').html(html);
                    tuyentqTheoQuyController.paging(response.total, function () {
                        tuyentqTheoQuyController.LoadData();
                    }, changePageSize);
